...
public class BulletSpawner : MonoBehaviour
{
    ...
    public enum EnemyType{Slime, SlimeBoss, Archer, Monk, SlimeBossBomb, Hashashin, Priestess, 
        Wizard, Goblin, Mushroom, Paladin, PaladinCross, NecroMeteo, NecroFollowMeteo}
    ...
    protected string GetBulletName(EnemyType enemyType){
        switch (enemyType)
        {
            ...
            case EnemyType.Paladin:
                return "Paladin_Pillar";
            case EnemyType.PaladinCross:
                return "Paladin_Cross";
            case EnemyType.NecroMeteo:
                return "Meteo";
            case EnemyType.NecroFollowMeteo:
                return "FollowMeteo";
